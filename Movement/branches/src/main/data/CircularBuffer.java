...
public class CircularBuffer {
	...
	/**
	 * Current position is the place in the buffer
	 * 	where the last point was added
	 */
	...
	/**
	 * Add a point (x, y) to the current position of the buffer
	...
	/**
	 * Get the last position of the buffer 
	 * 	Should be the one in front of the current
	 * 	If it is the end of the buffer it wraps around
	 * 
	 * @return
	 */
